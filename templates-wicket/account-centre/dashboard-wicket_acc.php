...
/**
 * ACC main dashboard template.
 *
 * This is the default template for Wicket Account Centre index page.
 *
 * This template can be overridden (at theme level) by copying it to yourtheme/templates-wicket/account-centre/dashboard-wicket_acc.php.
 */
