...
$tp = $args['tp'];
?>
<div class="event-card my-4 p-4 border border-gray-200 rounded-md shadow-md cursor-pointer" data-uuid="<?php echo $tp['id']; ?>">
	...
	<?php
	WACC()->render_block_template('modal-touchpoint-microspec', $tp);
	?>
</div>
