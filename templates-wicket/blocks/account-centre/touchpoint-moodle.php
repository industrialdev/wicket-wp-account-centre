...
use WicketAcc\Blocks\TouchpointMoodle\init as TouchpointMoodle;
...
if ($single_event) {
    ...
    if ($display == 'upcoming' || $display == 'all') {
        TouchpointMoodle::display_touchpoints($touchpoints_results['data'], 'upcoming', $num_results, false, $args);

        $close++;
    }

    if ($display == 'past' || $display == 'all') {
        TouchpointMoodle::display_touchpoints($touchpoints_results['data'], 'past', $num_results, false, $args);
