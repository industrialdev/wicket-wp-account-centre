...
use WicketAcc\Blocks\TouchpointCvent\init as TouchpointCvent;
		...
		<div
            ...
            if ($single_event) {
                ...
                if ($display == 'upcoming' || $display == 'all') {
                    TouchpointCvent::display_touchpoints($touchpoints_results['data'], 'upcoming', $num_results, false, $args);

                    $close++;
                }

                if ($display == 'past' || $display == 'all') {
                    TouchpointCvent::display_touchpoints($touchpoints_results['data'], 'past', $num_results, false, $args);
