...
$raw_start_date = $tp['attributes']['data']['event_start'];
...
$raw_end_date = $tp['attributes']['data']['event_end'];
...
<div class="event-card pheed <?php echo defined('WICKET_WP_THEME_V2') ? '' : 'my-0 p-4 border border-gray-200 gap-4 rounded-md shadow-md flex flex-col md:flex-row' ?>"
    ...
    <div class="flex-auto md:w-auto event-content-wrap">
        ...
        <?php if (isset($tp['attributes']['data']['url']) && $tp['attributes']['data']['url']) : ?>
            ...
            <h3 class="event-name <?php echo defined('WICKET_WP_THEME_V2') ? '' : 'text-lg font-bold mb-2' ?>">
                <?php echo $tp['attributes']['data']['event_name']; ?>
            </h3>
            <?php if (isset($tp['attributes']['data']['url']) && $tp['attributes']['data']['url']) : ?>
            </a>
        <?php endif; ?>
