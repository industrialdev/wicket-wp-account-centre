							...
							<div class="mt-2">
								<dl class="flex flex-wrap">
									<div class="flex w-full sm:w-1/2">
										...
										<dd class="ml-2 text-gray-700"><?php echo esc_html($tp['attributes']['data']['EventName']); ?></dd>
									</div>
									<div class="flex w-full sm:w-1/2">
										<dt class="font-medium text-gray-900"><?php esc_html_e('Badge Type:', 'wicket-acc'); ?></dt>
										<dd class="ml-2 text-gray-700"><?php echo esc_html($tp['attributes']['data']['BadgeType']); ?></dd>
									</div>
									<div class="flex w-full sm:w-1/2">
										<dt class="font-medium text-gray-900"><?php esc_html_e('Start Date:', 'wicket-acc'); ?></dt>
										<dd class="ml-2 text-gray-700"><?php echo date('M j, Y', strtotime($tp['attributes']['data']['StartDate'])); ?></dd>
									</div>
									<div class="flex w-full sm:w-1/2">
										<dt class="font-medium text-gray-900"><?php esc_html_e('End Date:', 'wicket-acc'); ?></dt>
										<dd class="ml-2 text-gray-700"><?php echo date('M j, Y', strtotime($tp['attributes']['data']['EndDate'])); ?></dd>
									</div>
								</dl>
							</div>
						</div>
