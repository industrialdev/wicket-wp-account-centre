...
use WicketAcc\Symfony\Component\Translation\Exception\InvalidArgumentException;
use WicketAcc\Symfony\Component\Translation\Exception\NotFoundResourceException;
use WicketAcc\Symfony\Component\Translation\Exception\RuntimeException;
use WicketAcc\Symfony\Component\Translation\Formatter\IntlFormatterInterface;
use WicketAcc\Symfony\Component\Translation\Formatter\MessageFormatter;
...
use WicketAcc\Symfony\Component\Translation\TranslatableMessage;
use WicketAcc\Symfony\Component\Translation\Translator;
...
class TranslatorTest extends TestCase
{
    ...
    public function testTransWithoutFallbackLocaleFile($format, $loader)
    {
        ...
        $loaderClass = 'WicketAcc\\Symfony\\Component\\Translation\\Loader\\' . $loader;
        $translator = new Translator('en');
    ...
    {
        $translator = new Translator('en_GB');
        $translator->addLoader('yml', new \WicketAcc\Symfony\Component\Translation\Loader\YamlFileLoader());
