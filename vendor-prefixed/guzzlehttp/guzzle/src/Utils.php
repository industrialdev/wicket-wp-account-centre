...
use WicketAcc\GuzzleHttp\Handler\CurlHandler;
use WicketAcc\GuzzleHttp\Handler\CurlMultiHandler;
...
final class Utils
{
     ...
     *
     * @return callable(\WicketAcc\Psr\Http\Message\RequestInterface, array): Promise\PromiseInterface Returns the best handler for the given system.
     *
