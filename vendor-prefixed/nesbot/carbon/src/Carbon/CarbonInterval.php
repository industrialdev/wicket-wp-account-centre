...
use WicketAcc\Carbon\Exceptions\BadFluentConstructorException;
use WicketAcc\Carbon\Exceptions\BadFluentSetterException;
...
use WicketAcc\Carbon\Exceptions\ParseErrorException;
use WicketAcc\Carbon\Exceptions\UnitNotConfiguredException;
use WicketAcc\Carbon\Exceptions\UnknownGetterException;
use WicketAcc\Carbon\Exceptions\UnknownSetterException;
use WicketAcc\Carbon\Exceptions\UnknownUnitException;
use WicketAcc\Carbon\Traits\IntervalRounding;
use WicketAcc\Carbon\Traits\IntervalStep;
use WicketAcc\Carbon\Traits\MagicParameter;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @throws \WicketAcc\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
     ...
     *    and rounded to the next smaller wicketacc_value (caution: 0.5w = 4d)
     *
    ...
    public function forHumans($syntax = null, $short = false, $parts = -1, $options = null)
    {
        ...
        $declensionMode = null;
        /** @var \WicketAcc\Symfony\Component\Translation\Translator $translator */
