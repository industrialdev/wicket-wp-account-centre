...
use WicketAcc\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

// @codeCoverageIgnoreStart
if (interface_exists('WicketAcc\\Symfony\\Contracts\\Translation\\TranslatorInterface') &&
    !interface_exists('WicketAcc\\Symfony\\Component\\Translation\\TranslatorInterface')
) {
    class_alias(
        'WicketAcc\\Symfony\\Contracts\\Translation\\TranslatorInterface',
        'WicketAcc\\Symfony\\Component\\Translation\\TranslatorInterface'
    );
}
...
trait Localization
{
     ...
     * @param \WicketAcc\Symfony\Component\Translation\MessageCatalogueInterface $catalogue
     *
     * @return mixed
     */
