...
class WicketCollection extends Collection
{
    protected $self;        // url
    protected $next;        // url
    protected $prev;        // url
    ...
    /**
     * @param $url
     * @return array|false|WicketCollection If the response has a `data` block, else the reponse.
     */
    public function getPage($url)
    {
        ...
        if (array_key_exists('meta', $response)
            ...
            $response = new self($response, $this->client);
        }
