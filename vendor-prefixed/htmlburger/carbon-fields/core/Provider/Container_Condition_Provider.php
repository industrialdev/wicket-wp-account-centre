...
class Container_Condition_Provider implements ServiceProviderInterface
{
    ...
    protected function install_container_conditions($ioc)
    {
        ...
        add_filter('carbon_fields_container_static_condition_types', function ($condition_types, $container_type, $container) {
            return array_merge(
                $condition_types,
                ['current_user_id', 'current_user_role', 'current_user_capability']
            );
        }, 10, 3);

        // add container-specific conditions
        add_filter('carbon_fields_post_meta_container_static_condition_types', [$this, 'filter_post_meta_container_static_condition_types'], 10, 3);
        add_filter('carbon_fields_post_meta_container_dynamic_condition_types', [$this, 'filter_post_meta_container_dynamic_condition_types'], 10, 3);

        add_filter('carbon_fields_term_meta_container_static_condition_types', [$this, 'filter_term_meta_container_static_condition_types'], 10, 3);
        add_filter('carbon_fields_term_meta_container_dynamic_condition_types', [$this, 'filter_term_meta_container_dynamic_condition_types'], 10, 3);

        add_filter('carbon_fields_user_meta_container_static_condition_types', [$this, 'filter_user_meta_container_static_condition_types'], 10, 3);
        add_filter('carbon_fields_user_meta_container_dynamic_condition_types', [$this, 'filter_user_meta_container_dynamic_condition_types'], 10, 3);

        add_filter('carbon_fields_theme_options_container_static_condition_types', [$this, 'filter_theme_options_container_static_condition_types'], 10, 3);
    }
    ...
    public function filter_post_meta_container_dynamic_condition_types($condition_types, $container_type, $container)
    {
        return array_merge(
            $condition_types,
            ['post_parent_id', 'post_ancestor_id', 'post_format', 'post_level', 'post_template', 'post_term']
        );
    }
    ...
    public function filter_term_meta_container_dynamic_condition_types($condition_types, $container_type, $container)
    {
        return array_merge(
            $condition_types,
            ['term_level', 'term_parent', 'term_ancestor']
        );
    }
