...
class Revisions_Service extends Service
{
    ...
    {
        remove_filter('carbon_get_post_meta_post_id', [$this, 'update_post_id_on_preview'], 10);
        remove_action('carbon_fields_post_meta_container_saved', [$this, 'maybe_copy_meta_to_revision'], 10);
        remove_filter('_wp_post_revision_fields', [$this, 'maybe_save_revision'], 10);
        remove_filter('_wp_post_revision_fields', [$this, 'add_fields_to_revision'], 10);
        remove_action('wp_restore_post_revision', [$this, 'restore_post_revision'], 10);
        remove_filter('wp_save_post_revision_check_for_changes', [$this, 'check_for_changes'], 10);
    }
