...
class Value_Set
{
     ...
     * @var array
     */
    protected $valid_types = [self::TYPE_SINGLE_VALUE, self::TYPE_MULTIPLE_VALUES, self::TYPE_MULTIPLE_PROPERTIES, self::TYPE_VALUE_SET];
    ...
    protected $empty_values = [
        ...
        self::TYPE_MULTIPLE_PROPERTIES => [],
        self::TYPE_VALUE_SET => [],
    ];

    /**
     * Registered value set properties (properties) with their default wicketacc_value (when the property is missing in the passed raw_value_set).
     *
     * @var array
     */
    protected $properties = [self::VALUE_PROPERTY => ''];
     ...
     *
     * @param int $type static::TYPE_* constant
     * @param array $additional_properties
     */
    public function __construct($type = self::TYPE_SINGLE_VALUE, $additional_properties = [])
    {
    ...
    protected function get_formatted_value_set($raw_value_set)
    {
        ...
        foreach ($raw_value_set as $raw_value) {
            ...
            foreach ($this->properties as $property => $default_value) {
                $formatted_value[$property] = $raw_value[$property] ?? $default_value;
            }
