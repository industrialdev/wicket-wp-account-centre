...
class Term_Meta_Container extends Container
{
    ...
    public function init()
    {
        ...
        add_action('init', [$this, 'hook_to_taxonomies'], 999999);
    }
    ...
    protected function get_environment_for_request()
    {
        ...
        $request_taxonomy = $input['taxonomy'] ?? '';
    ...
    public function attach()
    {
        ...
        foreach ($taxonomies as $taxonomy) {
            ...
            add_action($taxonomy . '_add_form_fields', [$this, 'render'], 10, 2);
        }
    }
    ...
    public function get_taxonomy_visibility()
    {
        ...
        $evaluated_collection = $this->condition_collection->evaluate(['term_taxonomy'], true, [], true);
