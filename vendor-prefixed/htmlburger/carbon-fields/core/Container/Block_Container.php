...
class Block_Container extends Container
{
    ...
    {
        add_filter('block_categories_all', [$this, 'attach_block_category'], 10, 2);
    ...
    public function set_parent($parent = null)
    {
        ...
        $this->settings['parent'] = is_string($parent) ? [$parent] : $parent;
    ...
    protected function register_block()
    {
        ...
        $editor_style = $this->settings['editor_style'] ?? null;
        ...
        register_block_type($this->get_block_type_name(), [
            'style' => $style,
