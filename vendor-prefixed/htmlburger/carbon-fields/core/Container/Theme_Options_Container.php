...
class Theme_Options_Container extends Container
{
    ...
    public function init()
    {
        ...
        if ($registered) {
            add_action('admin_menu', [$this, '_attach']);
        }
    }
    ...
    public function attach()
    {
        ...
        add_action('load-' . $page_hook, [$this, '_save']);
    }
    ...
    {
        $input = stripslashes_deep($_GET);
        $request_settings_updated = $input['settings-updated'] ?? '';
    ...
    protected function register_page()
    {
        ...
        if (!isset(static::$registered_pages[$parent])) {
            static::$registered_pages[$parent] = [];
        }
