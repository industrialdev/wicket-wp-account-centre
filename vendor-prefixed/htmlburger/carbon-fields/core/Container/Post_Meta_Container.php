...
class Post_Meta_Container extends Container
{
    ...
    /**
     * Create DataStore instance, set post ID to operate wicketacc_with (if such exists).
    ...
    public function init()
    {
        ...
        add_action('admin_init', [$this, '_attach']);
    ...
    public function save($post_id = null)
    {
        ...
        remove_action('save_post', [$this, '_save']);
    ...
    protected function get_environment_for_request()
    {
        ...
        $input = stripslashes_deep($_GET);
        $request_post_type = $input['post_type'] ?? '';
        $post_type = '';
    ...
    public function attach()
    {
        ...
        foreach ($this->post_types as $post_type) {
            ...
            add_filter("postbox_classes_{$post_type}_{$container_id}", [$this, 'add_postbox_classes']);
        }
    }
    ...
    public function get_post_type_visibility()
    {
        ...
        $evaluated_collection = $this->condition_collection->evaluate(['post_type'], true, [], true);
    ...
    public function show_on_template($template_path)
    {
        ...
        $template_paths = is_array($template_path) ? $template_path : [$template_path];
    ...
    {
        $post_formats = is_array($post_format) ? $post_format : [$post_format];
