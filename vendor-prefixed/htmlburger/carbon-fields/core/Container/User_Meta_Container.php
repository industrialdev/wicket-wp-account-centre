...
class User_Meta_Container extends Container
{
    ...
    public function init()
    {
        ...
        add_action('profile_update', [$this, '_save'], 10, 1);
        add_action('user_register', [$this, '_save'], 10, 1);
    }
    ...
    public function save($user_id = null)
    {
        ...
        remove_action('profile_update', [$this, '_save']);
    ...
    public function attach()
    {
        ...
        add_action('user_new_form', [$this, 'render'], 10, 1);
    }
