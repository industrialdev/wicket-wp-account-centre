...
class Nav_Menu_Item_Container extends Container
{
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        $callable = [static::class, 'edit_walker'];
    ...
    public function init($menu_item_id = 0)
    {
        ...
        if ($this->menu_item_id === 0) {
            ...
            add_action('carbon_fields_print_nav_menu_item_container_fields', [$this, 'form'], 10, 5);
        }
