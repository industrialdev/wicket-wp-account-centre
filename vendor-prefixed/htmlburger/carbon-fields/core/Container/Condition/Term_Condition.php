...
class Term_Condition extends Condition
{
    ...
    public function get_value()
    {
        ...
        if (is_array($value)) {
            if (isset($value['value'])) {
                ...
                $value = array_map([$this->wp_toolset, 'wildcard_term_descriptor_to_full_term_descriptor'], $value);
            }
        }
    ...
    {
        return array_map([$this, 'get_term_id_from_full_term_descriptor'], $full_term_descriptors);
    }
