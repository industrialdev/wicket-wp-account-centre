...
class Sidebar_Manager
{
    ...
    public function boot()
    {
        ...
        add_action('widgets_init', [$this, 'register_sidebars'], 100);
        ...
        // Ajax listeners
        add_action('wp_ajax_carbon_fields_add_sidebar', [$this, 'action_handler']);
        add_action('wp_ajax_carbon_fields_remove_sidebar', [$this, 'action_handler']);
    }
    ...
    {
        return apply_filters('carbon_fields_sidebars', get_option('carbon_custom_sidebars', []));
    }
    ...
    {
        $registered_sidebars = $this->get_sidebars();
        $default_options = apply_filters('carbon_fields_sidebar_default_options', []);
    ...
    {
        wp_enqueue_style('carbon-sidebar-manager', \Carbon_Fields\URL . '/core/Libraries/Sidebar_Manager/assets/css/app.css', [], \Carbon_Fields\VERSION);
        wp_enqueue_script('carbon-sidebar-manager', \Carbon_Fields\URL . '/core/Libraries/Sidebar_Manager/assets/js/app.js', [], \Carbon_Fields\VERSION);
        wp_localize_script(
