...
class Loader
{
    ...
    public function enqueue_assets()
    {
        ...
        $this->enqueue_script('vendor', ['wp-polyfill', 'jquery', 'lodash']);
        ...
        wp_localize_script('carbon-fields-vendor', 'cf', apply_filters('carbon_fields_config', [
            'config' => [
    ...
    public function fetch_association_options()
    {
        ...
        return wp_send_json_success($field->get_options([
            'page' => $page,
            'term' => $term,
        ]));
    }
