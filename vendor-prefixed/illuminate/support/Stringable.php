...
class Stringable implements JsonSerializable, ArrayAccess
{
     ...
     * @param  int  $limit
     * @return \WicketAcc\Illuminate\Support\Collection<int, string>
     */
    public function explode($delimiter, $limit = PHP_INT_MAX)
    {
        return wicketacc_collect(explode($delimiter, $this->value, $limit));
    }
    ...
    public function split($pattern, $limit = -1, $flags = 0)
    {
        if (filter_var($pattern, FILTER_VALIDATE_INT) !== false) {
            return wicketacc_collect(mb_str_split($this->value, $pattern));
        }
    ...
    {
        return wicketacc_collect(sscanf($this->value, $format));
    }
    ...
    {
        return wicketacc_collect(Str::ucsplit($this->value));
    }
     ...
     * @return string
     */
    public function wicketacc_value()
    {
