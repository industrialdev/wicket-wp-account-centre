 ...
 * @method static \WicketAcc\GuzzleHttp\Promise\PromiseInterface response(array|string|null $body = null, int $status = 200, array $headers = [])
 ...
 * @method static \WicketAcc\Illuminate\Support\Collection recorded(callable $callback = null)
 * @method static \WicketAcc\Illuminate\Contracts\Events\Dispatcher|null getDispatcher()
 ...
 * @method static \Illuminate\Http\Client\PendingRequest withBody(\WicketAcc\Psr\Http\Message\StreamInterface|string $content, string $contentType = 'application/json')
 ...
 * @method static \Illuminate\Http\Client\PendingRequest wicketacc_retry(array|int $times, \Closure|int $sleepMilliseconds = 0, callable|null $when = null, bool $throw = true)
 ...
 * @method static \Illuminate\Http\Client\Response wicketacc_head(string $url, array|string|null $query = null)
 ...
 * @method static \WicketAcc\GuzzleHttp\Client buildClient()
 * @method static \WicketAcc\GuzzleHttp\Client createClient(\WicketAcc\GuzzleHttp\HandlerStack $handlerStack)
 * @method static \WicketAcc\GuzzleHttp\HandlerStack buildHandlerStack()
 * @method static \WicketAcc\GuzzleHttp\HandlerStack pushHandlers(\WicketAcc\GuzzleHttp\HandlerStack $handlerStack)
 * @method static \Closure buildBeforeSendingHandler()
 * @method static \Closure buildRecorderHandler()
 * @method static \Closure buildStubHandler()
 * @method static \WicketAcc\GuzzleHttp\Psr7\RequestInterface runBeforeSendingCallbacks(\WicketAcc\GuzzleHttp\Psr7\RequestInterface $request, array $options)
 * @method static array mergeOptions(array ...$options)
 * @method static \Illuminate\Http\Client\PendingRequest stub(callable $callback)
 * @method static \Illuminate\Http\Client\PendingRequest async(bool $async = true)
 * @method static \WicketAcc\GuzzleHttp\Promise\PromiseInterface|null getPromise()
 * @method static \Illuminate\Http\Client\PendingRequest setClient(\WicketAcc\GuzzleHttp\Client $client)
...
class Http extends Facade
{
    ...
    {
        return wicketacc_tap(static::getFacadeRoot(), function ($fake) use ($callback) {
    ...
    {
        $fake = wicketacc_tap(static::getFacadeRoot(), function ($fake) {
            static::swap($fake);
        });
    ...
    {
        return wicketacc_tap(static::getFacadeRoot(), function ($fake) {
    ...
    {
        return wicketacc_tap(static::getFacadeRoot(), function ($fake) use ($url, $callback) {
