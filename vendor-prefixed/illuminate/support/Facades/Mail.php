...
use WicketAcc\Illuminate\Support\Testing\Fakes\MailFake;

/**
 * @method static \WicketAcc\Illuminate\Contracts\Mail\Mailer mailer(string|null $name = null)
 ...
 * @method static \Illuminate\Mail\MailManager setApplication(\WicketAcc\Illuminate\Contracts\Foundation\Application $app)
 ...
 * @method static \Illuminate\Mail\SentMessage|null send(\WicketAcc\Illuminate\Contracts\Mail\Mailable|string|array $view, array $data = [], \Closure|string|null $callback = null)
 * @method static mixed queue(\WicketAcc\Illuminate\Contracts\Mail\Mailable|string|array $view, string|null $queue = null)
 * @method static mixed onQueue(string $queue, \WicketAcc\Illuminate\Contracts\Mail\Mailable $view)
 * @method static mixed queueOn(string $queue, \WicketAcc\Illuminate\Contracts\Mail\Mailable $view)
 * @method static mixed later(\DateTimeInterface|\DateInterval|int $delay, \WicketAcc\Illuminate\Contracts\Mail\Mailable $view, string|null $queue = null)
 * @method static mixed laterOn(string $queue, \DateTimeInterface|\DateInterval|int $delay, \WicketAcc\Illuminate\Contracts\Mail\Mailable $view)
 * @method static \Symfony\Component\Mailer\Transport\TransportInterface getSymfonyTransport()
 * @method static \WicketAcc\Illuminate\Contracts\View\Factory getViewFactory()
 * @method static void setSymfonyTransport(\Symfony\Component\Mailer\Transport\TransportInterface $transport)
 * @method static \Illuminate\Mail\Mailer setQueue(\WicketAcc\Illuminate\Contracts\Queue\Factory $queue)
 ...
 * @method static \WicketAcc\Illuminate\Support\Collection sent(string|\Closure $mailable, callable|null $callback = null)
 * @method static bool hasSent(string $mailable)
 * @method static \WicketAcc\Illuminate\Support\Collection queued(string|\Closure $mailable, callable|null $callback = null)
...
class Mail extends Facade
{
    ...
    public static function fake()
    {
        ...
        return wicketacc_tap(new MailFake($actualMailManager), function ($fake) {
            static::swap($fake);
        });
    }
