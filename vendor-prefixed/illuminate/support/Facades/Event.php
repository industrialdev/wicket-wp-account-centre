...
use WicketAcc\Illuminate\Support\Testing\Fakes\EventFake;
 ...
 * @method static \WicketAcc\Illuminate\Support\Testing\Fakes\EventFake except(array|string $eventsToDispatch)
 ...
 * @method static \WicketAcc\Illuminate\Support\Collection dispatched(string $event, callable|null $callback = null)
...
class Event extends Facade
{
    ...
    public static function fake($eventsToFake = [])
    {
        ...
        return wicketacc_tap(new EventFake($actualDispatcher, $eventsToFake), function ($fake) {
            static::swap($fake);
    ...
    public static function fakeFor(callable $callable, array $eventsToFake = [])
    {
        ...
        return wicketacc_tap($callable(), function () use ($originalDispatcher) {
