...
use WicketAcc\Illuminate\Support\Testing\Fakes\NotificationFake;

/**
 * @method static void send(\WicketAcc\Illuminate\Support\Collection|array|mixed $notifiables, mixed $notification)
 * @method static void sendNow(\WicketAcc\Illuminate\Support\Collection|array|mixed $notifiables, mixed $notification, array|null $channels = null)
 ...
 * @method static \Illuminate\Notifications\ChannelManager setContainer(\WicketAcc\Illuminate\Contracts\Container\Container $container)
 ...
 * @method static \WicketAcc\Illuminate\Support\Collection sent(mixed $notifiable, string $notification, callable|null $callback = null)
 * @method static bool hasSent(mixed $notifiable, string $notification)
 * @method static \WicketAcc\Illuminate\Support\Testing\Fakes\NotificationFake serializeAndRestore(bool $serializeAndRestore = true)
