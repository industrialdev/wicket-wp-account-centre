...
/**
 * @method static \WicketAcc\Illuminate\Contracts\Filesystem\Filesystem drive(string|null $name = null)
 * @method static \WicketAcc\Illuminate\Contracts\Filesystem\Filesystem disk(string|null $name = null)
 * @method static \WicketAcc\Illuminate\Contracts\Filesystem\Cloud cloud()
 * @method static \WicketAcc\Illuminate\Contracts\Filesystem\Filesystem build(string|array $config)
 * @method static \WicketAcc\Illuminate\Contracts\Filesystem\Filesystem createLocalDriver(array $config)
 * @method static \WicketAcc\Illuminate\Contracts\Filesystem\Filesystem createFtpDriver(array $config)
 * @method static \WicketAcc\Illuminate\Contracts\Filesystem\Filesystem createSftpDriver(array $config)
 * @method static \WicketAcc\Illuminate\Contracts\Filesystem\Cloud createS3Driver(array $config)
 * @method static \WicketAcc\Illuminate\Contracts\Filesystem\Filesystem createScopedDriver(array $config)
 ...
 * @method static \Illuminate\Filesystem\FilesystemManager setApplication(\WicketAcc\Illuminate\Contracts\Foundation\Application $app)
 * @method static bool exists(string $path)
 * @method static string|null get(string $path)
 * @method static resource|null readStream(string $path)
 * @method static bool put(string $path, \WicketAcc\Psr\Http\Message\StreamInterface|\Illuminate\Http\File|\Illuminate\Http\UploadedFile|string|resource $contents, mixed $options = [])
...
class Storage extends Facade
{
    ...
    public static function fake($disk = null, array $config = [])
    {
        ...
        return wicketacc_tap($fake)->buildTemporaryUrlsUsing(function ($path, $expiration) {
