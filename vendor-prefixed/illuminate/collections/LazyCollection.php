...
use stdClass;
use Traversable;
use WicketAcc\Illuminate\Contracts\Support\CanBeEscapedWhenCastToString;
use WicketAcc\Illuminate\Support\Traits\EnumeratesValues;
 ...
 *
 * @implements \WicketAcc\Illuminate\Support\Enumerable<TKey, TValue>
 */
class LazyCollection implements CanBeEscapedWhenCastToString, Enumerable
{
    /**
     * @use \WicketAcc\Illuminate\Support\Traits\EnumeratesValues<TKey, TValue>
     */
     ...
     *
     * @param  \WicketAcc\Illuminate\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|(Closure(): \Generator<TKey, TValue, mixed, void>)|self<TKey, TValue>|array<TKey, TValue>|null  $source
     * @return void
     */
     ...
     * @template TMakeValue
     *
     * @param  \WicketAcc\Illuminate\Contracts\Support\Arrayable<TMakeKey, TMakeValue>|iterable<TMakeKey, TMakeValue>|(Closure(): \Generator<TMakeKey, TMakeValue, mixed, void>)|self<TMakeKey, TMakeValue>|array<TMakeKey, TMakeValue>|null  $items
    ...
    {
        if (func_num_args() === 2) {
            return $this->contains(fn ($item) => wicketacc_data_get($item, $key) === $value);
        }
     ...
     *
     * @param  \WicketAcc\Illuminate\Contracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$arrays
     ...
     *
     * @param  \WicketAcc\Illuminate\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \WicketAcc\Illuminate\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \WicketAcc\Illuminate\Support\Enumerable<array-key, TKey>|array<array-key, TKey>  $keys
     * @return static
     */
     ...
     */
    public function wicketacc_last(?callable $callback = null, $default = null)
    {
        ...
        return $needle === $placeholder ? wicketacc_value($default) : $needle;
    }
    ...
    public function pluck($value, $key = null)
    {
        return new static(function () use ($value, $key) {
            ...
            foreach ($this as $item) {
                $itemValue = wicketacc_data_get($item, $value);

                if (is_null($key)) {
                    yield $itemValue;
                } else {
                    $itemKey = wicketacc_data_get($item, $key);
     ...
     *
     * @param  \WicketAcc\Illuminate\Contracts\Support\Arrayable<TKey, TMergeRecursiveValue>|iterable<TKey, TMergeRecursiveValue>  $items
     ...
     *
     * @param  \WicketAcc\Illuminate\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string  $keys
     * @return static
     */
     ...
     * @template TZipValue
     *
     * @param  \WicketAcc\Illuminate\Contracts\Support\Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue>  ...$items
