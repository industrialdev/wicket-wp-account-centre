...
trait EnumeratesValues
{
     ...
     */
    public function wicketacc_value($key, $default = null)
    {
        if ($value = $this->firstWhere($key)) {
            return wicketacc_data_get($value, $key, $default);
        }
    ...
    {
        return $this->filter(
            fn ($item) => wicketacc_data_get($item, $key) < reset($values) || wicketacc_data_get($item, $key) > end($values)
        );
    }
    ...
    protected function operatorForWhere($key, $operator = null, $value = null)
    {
        ...
        return function ($item) use ($key, $operator, $value) {
            $retrieved = wicketacc_data_get($item, $key);
    ...
    protected function valueRetriever($value)
    {
        ...
        return fn ($item) => wicketacc_data_get($item, $value);
    }
