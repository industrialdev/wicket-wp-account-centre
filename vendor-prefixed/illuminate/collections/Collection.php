...
class Collection implements ArrayAccess, CanBeEscapedWhenCastToString, Enumerable
{
     ...
     *
     * @param  \WicketAcc\Illuminate\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|null  $items
     * @return void
     */
     ...
     *
     * @return \WicketAcc\Illuminate\Support\LazyCollection<TKey, TValue>
     */
     ...
     *
     * @param  \WicketAcc\Illuminate\Contracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$lists
    ...
    public function getOrPut($key, $value)
    {
        ...
        $this->offsetSet($key, $value = wicketacc_value($value));
     ...
     *
     * @param  \WicketAcc\Illuminate\Contracts\Support\Arrayable<array-key, TCombineValue>|iterable<array-key, TCombineValue>  $values
     ...
     *
     * @param  \WicketAcc\Illuminate\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string|null  $keys
     * @return static
     */
        ...
        uasort($items, function ($a, $b) use ($comparisons, $options) {
            foreach ($comparisons as $comparison) {
                ...
                if (!is_string($prop) && is_callable($prop)) {
                    ...
                    $values = [data_get($a, $prop), wicketacc_data_get($b, $prop)];
     ...
     * @return $this
     */
    public function wicketacc_transform(callable $callback)
    {
