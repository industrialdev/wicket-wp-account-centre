...
use Exception;
use WicketAcc\Firebase\JWT\JWT;
use WicketAcc\Firebase\JWT\Key;
use WicketAcc\GuzzleHttp;
...
class Client
{
	...
	private $app_key;
	private $api_key;
	/** @var \WicketAcc\GuzzleHttp\Client */
	private $client;
	...
	public function __construct($app_key = null, $api_key = null, $api_endpoint = 'http://localhost:3000/')
	{
		...
		$this->client = new \WicketAcc\GuzzleHttp\Client(['base_uri' => $this->api_endpoint, 'verify' => false]);
	...
	private function makeRequest(string $http_verb = 'GET', $method, $args)
	{
		...
		$request = new \WicketAcc\GuzzleHttp\Psr7\Request($http_verb, $method, [
