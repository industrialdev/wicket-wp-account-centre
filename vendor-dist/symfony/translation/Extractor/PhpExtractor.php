...
namespace WicketAcc\Symfony\Component\Translation\Extractor;

wicketacc_trigger_deprecation('symfony/translation', '6.2', '"%s" is deprecated, use "%s" instead.', PhpExtractor::class, PhpAstExtractor::class);
...
class PhpExtractor extends AbstractFileExtractor implements ExtractorInterface
{
    ...
    protected $sequences = [
        ...
        [
            'new',
            '\WicketAcc\Symfony\Component\Translation\TranslatableMessage',
            '(',
            self::MESSAGE_TOKEN,
            ',',
            self::METHOD_ARGUMENTS_TOKEN,
