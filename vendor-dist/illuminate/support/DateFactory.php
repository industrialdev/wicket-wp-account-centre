 ...
 *
 * @method \WicketAcc\Illuminate\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \WicketAcc\Illuminate\Support\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \WicketAcc\Illuminate\Support\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \WicketAcc\Illuminate\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \WicketAcc\Illuminate\Support\Carbon createFromTimeString($time, $tz = null)
 * @method \WicketAcc\Illuminate\Support\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \WicketAcc\Illuminate\Support\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \WicketAcc\Illuminate\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \WicketAcc\Illuminate\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \WicketAcc\Illuminate\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 ...
 * @method \WicketAcc\Illuminate\Support\Carbon fromSerialized($value)
 ...
 * @method \WicketAcc\Illuminate\Support\Carbon|null getTestNow()
 * @method \WicketAcc\Symfony\Component\Translation\TranslatorInterface getTranslator()
 ...
 * @method \WicketAcc\Illuminate\Support\Carbon instance($date)
 ...
 * @method \WicketAcc\Illuminate\Support\Carbon|null make($var)
 * @method \WicketAcc\Illuminate\Support\Carbon maxValue()
 * @method \WicketAcc\Illuminate\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \WicketAcc\Illuminate\Support\Carbon now($tz = null)
 * @method \WicketAcc\Illuminate\Support\Carbon parse($time = null, $tz = null)
 ...
 * @method void setTranslator(\WicketAcc\Symfony\Component\Translation\TranslatorInterface $translator)
 ...
 * @method \WicketAcc\Illuminate\Support\Carbon today($tz = null)
 * @method \WicketAcc\Illuminate\Support\Carbon tomorrow($tz = null)
 ...
 * @method \WicketAcc\Illuminate\Support\Carbon yesterday($tz = null)
 */
class DateFactory
{
    /**
