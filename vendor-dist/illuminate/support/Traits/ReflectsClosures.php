...
use Closure;
use WicketAcc\Illuminate\Support\Reflector;
...
trait ReflectsClosures
{
    ...
    protected function firstClosureParameterTypes(Closure $closure)
    {
        ...
        $types = wicketacc_collect($reflection->getParameters())->mapWithKeys(function ($parameter) {
    ...
    protected function closureParameterTypes(Closure $closure)
    {
        ...
        return wicketacc_collect($reflection->getParameters())->mapWithKeys(function ($parameter) {
            if ($parameter->isVariadic()) {
                return [$parameter->getName() => null];
            }
