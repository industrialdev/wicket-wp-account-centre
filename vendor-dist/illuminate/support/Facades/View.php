...
/**
 * @method static \WicketAcc\Illuminate\Contracts\View\View file(string $path, \WicketAcc\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \WicketAcc\Illuminate\Contracts\View\View make(string $view, \WicketAcc\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \WicketAcc\Illuminate\Contracts\View\View first(array $views, \WicketAcc\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderWhen(bool $condition, string $view, \WicketAcc\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderUnless(bool $condition, string $view, \WicketAcc\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 * @method static bool exists(string $view)
 * @method static \WicketAcc\Illuminate\Contracts\View\Engine getEngineFromPath(string $path)
 ...
 * @method static \WicketAcc\Illuminate\Contracts\Container\Container getContainer()
 * @method static void setContainer(\WicketAcc\Illuminate\Contracts\Container\Container $container)
 ...
 * @method static void startComponent(\WicketAcc\Illuminate\Contracts\View\View|\WicketAcc\Illuminate\Contracts\Support\Htmlable|\Closure|string $view, array $data = [])
 ...
 * @method static void callComposer(\WicketAcc\Illuminate\Contracts\View\View $view)
 * @method static void callCreator(\WicketAcc\Illuminate\Contracts\View\View $view)
