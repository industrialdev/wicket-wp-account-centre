 ...
 * @method static void write(string $level, \WicketAcc\Illuminate\Contracts\Support\Arrayable|\WicketAcc\Illuminate\Contracts\Support\Jsonable|\WicketAcc\Illuminate\Support\Stringable|array|string $message, array $context = [])
 * @method static \Illuminate\Log\Logger withContext(array $context = [])
 * @method static void listen(\Closure $callback)
 * @method static \Psr\Log\LoggerInterface getLogger()
 * @method static \WicketAcc\Illuminate\Contracts\Events\Dispatcher getEventDispatcher()
 * @method static void setEventDispatcher(\WicketAcc\Illuminate\Contracts\Events\Dispatcher $dispatcher)
