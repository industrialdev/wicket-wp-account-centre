 ...
 * @method static \WicketAcc\Illuminate\Contracts\Session\Session session()
 * @method static void setLaravelSession(\WicketAcc\Illuminate\Contracts\Session\Session $session)
 ...
 * @method static bool wicketacc_filled(string|array $key)
 ...
 * @method static \WicketAcc\Illuminate\Support\Stringable wicketacc_str(string $key, mixed $default = null)
 * @method static \WicketAcc\Illuminate\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \WicketAcc\Illuminate\Support\Carbon|null date(string $key, string|null $format = null, string|null $tz = null)
 * @method static object|null enum(string $key, string $enumClass)
 * @method static \WicketAcc\Illuminate\Support\Collection wicketacc_collect(array|string|null $key = null)
