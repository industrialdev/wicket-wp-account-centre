...
class Sleep
{
     ...
     *
     * @var array<int, \WicketAcc\Carbon\CarbonInterval>
     */
    ...
    protected function pullPending()
    {
        ...
        return wicketacc_tap($this->pending, function () {
            $this->pending = null;
        });
    }
    ...
    {
        $count = wicketacc_collect(static::$sequence)->filter($expected)->count();
    ...
    {
        $this->shouldSleep = (bool) wicketacc_value($condition, $this);
